 ...
 * @param {Function} props.onColor 点击"色彩"回调
 * @param {Function} props.onExport 点击"导出网页"回调
 */
export default function ActionBar({ onPreview, onColor, onExport }) {
  return (
    <div className="action-bar">
      <button className="action-btn" onClick={onPreview}>预览</button>
      <button className="action-btn" onClick={onColor}>色彩</button>
